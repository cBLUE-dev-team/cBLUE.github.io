classdef SurfaceSpectrum < handle
    ...
    methods
        function obj = SurfaceSpectrum(wave_age)
            ...
            s = 6;  % MAGIC NUMBER - REASON UNKNOWN
            obj.SF = Cos2S_spread(ang,s); % Spreading function
        ...
        function SetWind(obj, wind)
            ...
            [S,~,~,~,~] = ECKV_spectrum(obj.k, wind, obj.wave_age);
        ...
        function [face_normals] = Sample(obj, t)
